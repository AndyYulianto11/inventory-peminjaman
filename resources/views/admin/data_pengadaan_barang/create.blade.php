                    ...
                    <div class="card-body">
                        ...
                        <form id="modal-form">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="kode_transaksi" name="kode_transaksi" value="{{ $kodeTransaksi }}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="{{ $currentDateTime->format('d-m-Y') }}" readonly>
                                    <input type="hidden" class="form-control" id="tgl_transaksi" name="tgl_transaksi" value="{{ $currentDateTime }}">
                                </div>
                            </div>
                            ...
                            <div class="text-right mb-3">
                                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#itemModal">Data Item</button>
...
<script>
    $(document).ready(function() {
        ...
        // Fungsi untuk mendapatkan data dan menampilkan di modal
                ...
                success: function(response) {
                    ...
                    $.each(response.item_data, function(index, item) {
                        $('#itemDataBody').append(
                            ...
                            '<td>' + '<button class="btn btn-success btn-sm" onclick="fungsiTombol()"><i class="fas fa-plus-square"></i></button>' + '</td>' +
                            '</tr>'
                        );
                        nomorUrut++;
                    });
