...
@section('title', 'Detail Data Pengadaan Barang - Keuangan')
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('cetak-datatransaksipengadaan', $datapengadaanbarang->id) }}" type="button" class="btn btn-tool" target="_blank">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <a href="/cek-datatransaksipengadaan" class="btn btn-success btn-sm btn-flat">Kembali</a>
                        </div>
                    </div>
                    <!-- /.card-body -->
                </div>
