...
@section('title', 'Edit Data Aset Unit - Administrator')
        ...
        <div class="container-fluid">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="{{ route('update-cek-dataasetunit', $dataasetunit->id) }}" method="POST" id="updateForm">
                            @csrf
                            @method('PUT')
                            <table>
                                <tr>
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            setTimeout(function() {
                                window.location.href = "{{ route('cek-dataasetunit') }}";
                            }, 1500);
                        },
