...
@section('title', 'Detail Data Pengadaan Barang - Rektorat')
        ...
        <div class="container-fluid">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="{{route('pengadaan-barang-rektor-update')}}" method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" id="status" data-status="{{$datapengadaanbarang->status_setujurektorat}}" name="status_setujurektorat" @if($datapengadaanbarang->status_setujurektorat != 1) disabled @endif>
                                        <option value="{{ $datapengadaanbarang->status_setujurektorat }}" selected disabled>
                                            @if($datapengadaanbarang->status_setujurektorat == '0')
                                                Draft
                                            @elseif($datapengadaanbarang->status_setujurektorat == '1')
                                                Diajukan
                            ...
                            <div class="form-group mt-4">
                                <textarea name="status_item" cols="30" rows="5" class="form-control" placeholder="@if($datapengadaanbarang->komentar == '') Tidak ada komentar @endif" @if($datapengadaanbarang->status_setujurektorat != 1) disabled @endif>@if($datapengadaanbarang->status_setujurektorat != 1){{ $datapengadaanbarang->komentar }}@endif</textarea>
                            </div>
                            <br><br>
                            <div class="form-group">
                                @if($datapengadaanbarang->status_setujurektorat == 1)
                                <input type="submit" id="buttonSave" disabled class="btn btn-danger btn-sm btn-flat" value="Akhiri Pengecekan Data">
                                @endif
                                <a href="/detail-datapengadaanbarang" class="btn btn-success btn-sm btn-flat">Kembali</a>
                            </div>
                        </form>
                    </div>
                    <!-- /.card-body -->
